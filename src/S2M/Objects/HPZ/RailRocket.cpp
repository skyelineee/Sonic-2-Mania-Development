...
void RailRocket::Draw()
{
    ...
    this->animator.SetAnimation(sVars->aniFrames, 0, true, this->frame); // this is still animated like v4 so it can retain the animation speed changing on depending on the objects speed
